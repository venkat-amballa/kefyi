...
class UserRegister(Resource):
    ...
    parser.add_argument(
        "username", type=str, required=True, help="usernmae is a Mandatory field"
    )
    parser.add_argument(
        "first_name",
        type=str,
    ...
    parser.add_argument(
        "password", type=str, required=True, help="Password for the user is required"
    )
    parser.add_argument("email", type=str, help="Email of the user is Optional")
    parser.add_argument("address", type=str, help="Address of the user is Optional")
    parser.add_argument(
...
_user_parser.add_argument(
    ...
    type=str,
    required=True,
    help="First Neame of the user is a Mandatory field",
)
_user_parser.add_argument(
    ...
    def post(cls):
        ...
        if user and safe_str_cmp(user.password, data.get("password", None)):
            ...
            jwt_token = create_access_token(
                identity=user.id, fresh=True, expires_delta=TOKEN_EXPIRES
            )
